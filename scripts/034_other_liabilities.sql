CREATE TABLE other_liabilities_master (
...
CREATE TABLE other_liabilities_transactions (
...
VALUES(23108001, 18010000, 'Interest Accrued on Deposits', 1, B'1',18000000, 0, B'1', now(), now()),
(23108001, 18020000, 'Interest Accrued on Borrowings', 1, B'1',18000000, 0, B'1', now(), now()),
(23108001, 18030000, 'Unclaimed Dividend', 1, B'1',18000000, 0, B'1', now(), now()),
(23108001, 18040000, 'Other Liabilities(Annexure-V)', 1, B'1',18000000, 0, B'1', now(), now());
