CREATE TABLE grands_and_subsidies_master (
...
CREATE TABLE grands_and_subsidies_transactions (
...
VALUES(23108001, 16010000, 'Subsidy meant for Members', 1, B'1',16000000, 0, B'0', now(), now()),
(23108001, 16020000, 'Subsidy meant for Society', 1, B'1',16000000, 0, B'0', now(), now()),
(23108001, 16030000, 'Funds Received From Govt', 1, B'1',16000000, 0, B'0', now(), now()),
(23108001, 16040000, 'Others (Annexure-II)', 1, B'1',16000000, 0, B'1', now(), now());
