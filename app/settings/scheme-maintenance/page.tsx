        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Create and maintain deposit, loan, and savings schemes</p>
            </div>
          </div>
        </div>
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-16">
            ...
            <CardDescription className="text-center max-w-md">
              The Scheme Maintenance module is under development. You will be able to create and manage deposit, loan, and savings schemes here.
            </CardDescription>
          </CardContent>
        </Card>
      </div>
