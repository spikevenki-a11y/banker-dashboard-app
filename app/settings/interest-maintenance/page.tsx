...
import { ArrowLeft, Percent, Construction } from "lucide-react"
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground">Configure interest rates, slabs, and calculation parameters</p>
            </div>
          </div>
        </div>
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-16">
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-rose-50 mb-4">
              <Construction className="h-8 w-8 text-rose-600" />
            </div>
            <CardTitle className="text-xl mb-2">Coming Soon</CardTitle>
            <CardDescription className="text-center max-w-md">
              The Interest Maintenance module is under development. You will be able to configure interest rates, slabs, and calculation parameters here.
            </CardDescription>
          </CardContent>
        </Card>
      </div>
