...
export default function MembersPage() {
  ...
  // View member moved to /members/view page
          ...
          <main className="flex-1 overflow-y-auto bg-background p-6">
            ...
            <div className="mb-6 grid gap-4 md:grid-cols-3">
              <Card
                ...
                onClick={() => router.push("/members/enroll")}
              >
              ...
              <Card
                className="cursor-pointer transition-all hover:shadow-lg hover:border-primary"
                onClick={() => router.push("/members/view")}
              >
                <CardHeader className="pb-3">
                  <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-primary/10">
                    <UserPlus className="h-6 w-6 text-primary" />
              ...
              <Card
                ...
                onClick={() => router.push("/members/share-deposit")}
              >
                <CardHeader className="pb-3">
              ...
              <Card
                ...
                onClick={() => router.push("/members/share-withdrawal")}
              >
                <CardHeader className="pb-3">
            ...
            {/* Enroll Member dialog removed - now a separate page at /members/enroll */}

            {/* View Member dialog removed - now a separate page at /members/view */}
            ...
            {/* Share Deposit/Withdrawal/Batch/Member Search dialogs removed - now separate pages */}
