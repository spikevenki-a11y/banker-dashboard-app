...
export default function ShareDepositPage() {
  ...
  const [shareDepositMemberNo, setShareDepositMemberNo] = useState(initialMemberNo)
  ...
  useEffect(() => {
    if (initialMemberNo) {
      handleMembershipBlur(initialMemberNo)
    }
  }, [initialMemberNo])
    ...
    <DashboardWrapper>
      <div className="flex flex-col gap-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-foreground">Share Deposit</h1>
            <p className="text-sm text-muted-foreground">Add shares for a member account</p>
          </div>
        </div>
